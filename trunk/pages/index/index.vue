	...
	<view class="content">
        ...
        <view v-if="state == 3" class="">
            <view class="topBox">
                ...
                <view class="topTitle" style="float: right;">
            ...
            <view class="communityBox">
                ...
                <view class="" style="font-size: 26upx; margin-top: 20upx;">
                    {{!community.tags ? '' : community.tags.join(" / ")}}
                </view>
                <view class="">
                    站主：{{!community.companyName ? '' : community.companyName}}
                </view>
            </view>
            <view class="btnBox">
                <view class="fwqbtn">服务区</view>
                <view class="jkscbtn" @click="clickMall" ><image src="../../static/image/jiankangshangcheng.png" mode=""></image>健康商城</view>
            </view>
            <view class="titleBox">
            ...
            <view class="btnBox">
                ...
                <view class="gkfxbtn" @click="clickZixun">管家咨询</view>
            </view>
            ...
            <view class="btnBox" style="margin-bottom: 80upx;" >
                ...
                <view class="shareBtnBox">
                    ...
                    <view class="shareBtn" @click="clickMingyishuo" style="margin-top: 42upx;">
            ...
            <image v-if="community.expert.name" style="width: 598upx; height: 352upx; margin-left: 77upx;" src="../../static/image/home_yisheng.png" mode=""></image>
            <view v-if="community.expert.name" class="doctorBox">
                ...
                <view >
                    ...
                    <view class="" style="font-size: 29upx;">
                        {{!community.expert.title ? '' : community.expert.title}} | {{!community.expert.rank ? '' : community.expert.rank}} 
                    </view>
                </view>
            </view>
            <view v-if="community.expert.name" class="btnBox">
                <view class="gkfxbtn" @click="imageInterrogation" >图文问诊</view>
                <view class="gkfxbtn" @click="videoInterrogation" >视频问诊</view>
                <view class="jkscbtn" @click="clickReport('advisory_report','查看报告')" style="margin: 0upx;">查看报告</view>
            </view>
            ...
            <view class="evaluationBox">
                <view style="font-weight:450;font-size:32upx; color: #868E9D;">
                     服务站评价
                </view>
        ...
        <view v-if="mask" class="calendarBox">
            <view style="padding: 63upx 108upx 2upx 108upx; text-align: center;">您还没有加入哦，<br>请加入服务站后再操作！</view>
            <view class="btnBox">
	...
	export default {
        ...
        onShow() {
			...
			if(getApp().globalData.showIndex){
                if(this.searchCommunityid ){     //带服务站id
