        ...
        <view v-if="state == 3" class="">
            <view class="topBox">
                ...
                <view class="topTitle" style="float: right; margin-bottom: 26upx;margin-top: 10upx;">
                    <image @click="clickCard(1)" style="width: 42upx; height: 42upx; margin: 0;" src="../../static/image/home_ewm.png" mode=""></image> 
                    <image @click="clickCard(2)" style="width: 42upx; height: 42upx;margin: 0 0 0 42upx;" src="../../static/image/home_share.png" mode=""></image> 
                    <text style="font-size: 34upx; flex: 1;text-align: right;" @click="changeStation">切换服务站 ></text>
                </view>
            </view>
            ...
            <view class="btnBox">
                ...
                <view style="display: flex;flex-direction: row; flex: 1;flex-wrap:wrap;">
                    ...
                    <view class="jkscbtn" style="width: 212upx;margin-bottom: 20upx;" @click="clickTjian" ><image style="width: 38upx;" src="../../static/image/tijianbtn.png" mode=""></image>健康体检</view>
            ...
            <view class="doctorBox" style="margin:0upx" v-if="faceCheck.show">
                ...
                <view style="flex: 1;margin-right: 33rpx;">
                    <view class="" style="font-size: 35upx;color: #16202E;line-height: 34upx;overflow: hidden;text-overflow: ellipsis;word-break: break-all;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 1;">
                        {{faceCheck.name ? faceCheck.name : ''}}
                    </view>
                    <view class="" style="font-size: 27upx;margin: 16upx 0upx 16upx 0;line-height: 1.5;overflow: hidden;text-overflow: ellipsis;word-break: break-all;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 2;">
                        {{faceCheck.remark ?faceCheck.remark : ''}}
                    </view>
                    <view style="color: #16202E; display: flex; flex-direction: row;">
	...
	export default {
        ...
        onShow() {
			...
			if(getApp().globalData.showIndex){
                ...
                }else if(this.userinfo.followCommunityId){
                    this.findCommunity(this.userinfo.followCommunityId)
                }else{
                    uni.navigateTo({
		...
		methods: {
            ...
            clickMwozhibo:function(){
                ...
                uni.navigateTo({
                    url:'../liveborad/liveList?communityId=' + this.community.id
                })
            },
            gjziying:function(){
                if(!this.isShowjoin()){
            ...
            findCommunity:function(id){
                ...
                api.findCommunityById({
                    ...
                    if(res.status == 'OK'){
						...
						this.$store.commit('SET_COMMUNITY',this.community) 
            ...
            clickShare:function(id,type){
                ...
                if(type == 1){
                    ...
                    let customParams = encodeURIComponent(JSON.stringify({ communityId: this.searchCommunityid })) 
                    uni.navigateTo({
