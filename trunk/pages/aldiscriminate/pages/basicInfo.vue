<template>
	<view>
	<view v-if="type == 2" class="hintText1">
        ...
        <view class="contentBox">
            ...
            <!-- <scroll-view :style="{ height: boxHeight + 'px'}" scroll-y="true" > -->
                ...
                <view v-if="type != 2" :class="{animation:isActive2}" class="hintBox">
                    <image src="/pages/aldiscriminate/static/icon_jbxx_jgts.png" mode=""></image>
                    <view class="hintText">
...
<script>
    ...
    export default {
    	...
    	onLoad(options) {
            ...
            if (this.type == 2) uni.setNavigationBarTitle({title: '脏腑辨证'})
