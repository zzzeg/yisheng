...
// 健康体检机构 - 区域医院详情 -- 体检套餐类型
function healthKKpackageTypes(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'Content-Type':'application/json'
    ...
    return request.get({
        url: '/kkHospital/getType',
        data: obj,
        header: header
    },false)
}
// 健康体检机构 - 区域医院详情 -- 体检套餐根据类型查底下的套餐
function healthKKpackageTypesToList(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'Content-Type':'application/json'
...
function doctorReport(obj){
    ...
    return request.get({
        url: '/doctorReport/page',
        data: obj,
        header: header
    },false)
}
function checkupReport(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'content-type': 'application/json'
    ...
    return request.get({
        url: '/checkupReport/page',
        data: obj,
        header: header
    },false)
}
function deleteCheckupReport(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'content-type': 'application/x-www-form-urlencoded'
    ...
    return request.post({
        url: '/checkupReport/deleteById',
        data: obj,
        header: header
    },false)
}
function updateCheckupReport(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'content-type': 'application/json'
    ...
    return request.post({
        url: '/checkupReport/update',
        data: obj,
        header: header
    },false)
}
function findCheckupReport(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'content-type': 'application/json'
    ...
    return request.get({
        url: '/checkupReport/findById',
        data: obj,
        header: header
    },false)
}
function deleteDoctorReport(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'content-type': 'application/x-www-form-urlencoded'
    ...
    return request.post({
        url: '/doctorReport/deleteById',
        data: obj,
        header: header
    },false)
}
function updateDoctorReport(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'content-type': 'application/json'
    ...
    return request.post({
        url: '/doctorReport/update',
        data: obj,
        header: header
    },false)
}
function findDoctorReport(obj){
	const sessionKey = uni.getStorageSync('sessionId');
    const header = {
        'sskey': sessionKey,
        'content-type': 'application/json'
...
export default {
	...
	healthkkPackagePage,
	healthkkPackageById,
	healthKKpackageTypes,
	healthKKpackageTypesToList
}
