...
<style scoped lang="scss">
	...
	.searchItemsList {
		...
		.items{ 
			...
			.defaults{ font-size:24rpx; color:#434E5E; display:inline-block; padding:12rpx 20rpx; border-radius:20rpx; background:rgba(241,242,247,1); margin:0px 15rpx 25rpx 0rpx; 
