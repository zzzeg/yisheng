	...
	<view class="page" :class="isShare ? 'share-page' : ''">
		 ...
		 <template v-if="isShare && communityId">
			 <view class="content-desc">
                ...
                <u-parse v-if="info.content" class="video-content-text" :class="{'contentShow':contentFlag}" :content="info.content" @preview="preview" @navigate="navigate" ></u-parse>
			 </view>
		...
		<template v-else>
			<view class="video-center" :class="{'videoShow':contentFlag}">
				...
				<view class="video-content" >
					<!-- <text class="video-content-text" :class="{'contentShow':contentFlag}"> -->
                    <u-parse v-if="info.content" class="video-content-text" :class="{'contentShow':contentFlag}" :content="info.content" @preview="preview" @navigate="navigate" ></u-parse>
				...
				<view class="u-f-ac location">
					...
					<view>{{info.servicename ? info.servicename : ''}}</view>
				</view>
			</view>
			<!-- 评论 -->
...
<script>
	...
	export default {
		...
		onLoad(e) {
			...
			this.communityId = e.communityId || (this.$store.getters.communityId ? this.$store.getters.communityId : '');
