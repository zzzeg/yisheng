	...
	<view class="content">
        ...
        <view v-if="state == 3" class="">
            ...
            <view class="communityBox">
                ...
                <view class="" style="font-size: 22upx;margin: 12upx 60rpx 0rpx; height: 80upx;display:flex;align-items:flex-end;">
            ...
            <view class="btnBox">
                ...
                <view class="jkscbtn" @click="clickMall" ><image src="../../static/image/jiankangshangcheng.png" mode=""></image>健康产品</view>
            </view>
            <view class="titleBox">
...
<script>
	...
	export default {
     ...
     //         if(this.userinfo && this.userinfo.followCommunityId){
     //            var _self = this
     //            uni.checkSession({
     //                success() {
     ...
     //        }else if(this.userinfo && !this.userinfo.followCommunityId){
			  // uni.navigateTo({
