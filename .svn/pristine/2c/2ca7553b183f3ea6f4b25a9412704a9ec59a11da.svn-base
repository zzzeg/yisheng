<template>
	...
	<view class="cont" @click="clickHealth">
        ...
        <view v-if="login" class="cpt-mask"></view>
        <view v-if="login" class="calendarBox">
            ...
            <view style="display: flex;flex-direction: row; margin-top: 48upx; font-size: 31upx;">
                <view v-if="login == 1" @click="clickMask" class="calendarBtn" style="margin-right: 21upx; border:2upx solid rgba(1,172,130,1); color: #01AC82;">暂不登录</view>
