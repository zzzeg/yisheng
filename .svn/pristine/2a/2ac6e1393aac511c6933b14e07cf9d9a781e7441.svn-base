<template>
	<view>
        <view v-if="order" class="">
            ...
            <!-- 收货人信息 -->
            <view v-if="orderType != 'KK'" class="mk-form shape">
            	<view class="header">
            		收货人信息
            	</view>
            ...
            <view class="mk-form shape">
            	...
            	<view v-if="orderType != 'KK'" class="form-item-container">
...
<script>
	...
	export default {
		...
		methods: {
            manageData:function(){
                if(this.order.receivingAddress && JSON.parse(this.order.receivingAddress)){
